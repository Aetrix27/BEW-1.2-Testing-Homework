...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name="Tyler Blevins").one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, "Tyler Blevins")
        self.assertEqual(created_author.biography, "A legendary football player")
